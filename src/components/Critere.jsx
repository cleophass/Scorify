...
const Critere = () => {
    ...
    return (
      ...
      <div className="flex justify-between items-center mb-10">
        ...
        <div className="flex justify-between items-center mb-10">
        <div className="text-gray-900 text-3xl font-bold font-inter leading-[48px]">Evaluer les contrats</div>
        <NewCriteria/>
        </div>
        <div className="mb-5"><DeleteModal/></div>
        <div className="mb-10"><TableCriteria data={TableCritere}/></div>
