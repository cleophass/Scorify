    ...
    <div className="flex flex-col text-left style={{ width: '400px' }}">
      ...
      <div className="relative">
        <input
          ...
          style={{ width: '400px' }}
          className="w-full rounded-md border bg-transparent pr-10 px-5 py-3 text-base text-body-color outline-none focus:border-custom-blue focus:ring-0 dark:border-dark-3 dark:text-white"
          placeholder={label}
        />
