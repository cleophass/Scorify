...
const SuccessToaster = ({ message = "Success!", duration = 3000, onClose }) => {
    useEffect(() => {
        const timer = setTimeout(() => {
            if (onClose) onClose();  // Assurez-vous que la fonction onClose est fournie
        }, duration);  // Le toaster disparaît après le délai spécifié
