...
const ModalNewAffaire = () => {
    ...
    const handleNext = () => {
      navigate('/affaires/1/edit'); // Navigate to the specified path
        ...
        <div>
          ...
          >
            ...
            >
              ...
              <TextInput width="430px" label="Titre de l'affaire" />
              <div className="mb-10">
                <h1 className={`text-left mb-2 text-sm font-medium text-gray-700`}>Fournisseur</h1>
                <DropdownComponent label="Sélectionnez une fournisseur" width="430px" options={[{ label: "Admin" }, { label: "Collaborateur" }]} />
              </div>
...
export default ModalNewAffaire;
